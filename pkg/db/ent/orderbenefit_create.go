...
func (obc *OrderBenefitCreate) defaults() error {
	if _, ok := obc.mutation.CreatedAt(); !ok {
		if orderbenefit.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := orderbenefit.DefaultCreatedAt()
		obc.mutation.SetCreatedAt(v)
	}
	if _, ok := obc.mutation.UpdatedAt(); !ok {
		if orderbenefit.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := orderbenefit.DefaultUpdatedAt()
		obc.mutation.SetUpdatedAt(v)
	}
	if _, ok := obc.mutation.DeletedAt(); !ok {
		if orderbenefit.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := orderbenefit.DefaultDeletedAt()
		obc.mutation.SetDeletedAt(v)
	}
	if _, ok := obc.mutation.EntID(); !ok {
		if orderbenefit.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := orderbenefit.DefaultEntID()
		obc.mutation.SetEntID(v)
	}
	if _, ok := obc.mutation.AppID(); !ok {
		if orderbenefit.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := orderbenefit.DefaultAppID()
		obc.mutation.SetAppID(v)
	}
	if _, ok := obc.mutation.UserID(); !ok {
		if orderbenefit.DefaultUserID == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultUserID (forgotten import ent/runtime?)")
		}
		v := orderbenefit.DefaultUserID()
		obc.mutation.SetUserID(v)
	}
	if _, ok := obc.mutation.CoinTypeID(); !ok {
		if orderbenefit.DefaultCoinTypeID == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultCoinTypeID (forgotten import ent/runtime?)")
		}
		v := orderbenefit.DefaultCoinTypeID()
		obc.mutation.SetCoinTypeID(v)
	}
	if _, ok := obc.mutation.AccountID(); !ok {
		if orderbenefit.DefaultAccountID == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultAccountID (forgotten import ent/runtime?)")
		}
		v := orderbenefit.DefaultAccountID()
		obc.mutation.SetAccountID(v)
	}
	if _, ok := obc.mutation.OrderID(); !ok {
		if orderbenefit.DefaultOrderID == nil {
			return fmt.Errorf("ent: uninitialized orderbenefit.DefaultOrderID (forgotten import ent/runtime?)")
		}
...
func (obc *OrderBenefitCreate) check() error {
	if _, ok := obc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "OrderBenefit.created_at"`)}
	}
	if _, ok := obc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "OrderBenefit.updated_at"`)}
	}
	if _, ok := obc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "OrderBenefit.deleted_at"`)}
	}
	if _, ok := obc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "OrderBenefit.ent_id"`)}
	}
	return nil
}
...
func (u *OrderBenefitUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for OrderBenefitCreate.OnConflict")
	}
...
func (u *OrderBenefitUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the OrderBenefitCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for OrderBenefitCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
