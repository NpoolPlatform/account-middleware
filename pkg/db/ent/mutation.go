...
// LimitationMutation represents an operation that mutates the Limitation nodes in the graph.
type LimitationMutation struct {
	config
	op            Op
	typ           string
	id            *uuid.UUID
	...
	oldValue      func(context.Context) (*Limitation, error)
	predicates    []predicate.Limitation
}

var _ ent.Mutation = (*LimitationMutation)(nil)

// limitationOption allows management of the mutation configuration using functional options.
type limitationOption func(*LimitationMutation)

// newLimitationMutation creates new mutation for the Limitation entity.
func newLimitationMutation(c config, op Op, opts ...limitationOption) *LimitationMutation {
	m := &LimitationMutation{
		config:        c,
		op:            op,
		typ:           TypeLimitation,
		clearedFields: make(map[string]struct{}),
...
// withLimitationID sets the ID field of the mutation.
func withLimitationID(id uuid.UUID) limitationOption {
	return func(m *LimitationMutation) {
		var (
			err   error
			once  sync.Once
			value *Limitation
		)
		m.oldValue = func(ctx context.Context) (*Limitation, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().Limitation.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withLimitation sets the old Limitation of the mutation.
func withLimitation(node *Limitation) limitationOption {
	return func(m *LimitationMutation) {
		m.oldValue = func(context.Context) (*Limitation, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m LimitationMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m LimitationMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of Limitation entities.
func (m *LimitationMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *LimitationMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *LimitationMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().Limitation.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *LimitationMutation) SetCreatedAt(u uint32) {
	m.created_at = &u
	m.addcreated_at = nil
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *LimitationMutation) CreatedAt() (r uint32, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the Limitation entity.
// If the Limitation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LimitationMutation) OldCreatedAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddCreatedAt adds u to the "created_at" field.
func (m *LimitationMutation) AddCreatedAt(u int32) {
	if m.addcreated_at != nil {
		*m.addcreated_at += u
	} else {
		m.addcreated_at = &u
...
// AddedCreatedAt returns the value that was added to the "created_at" field in this mutation.
func (m *LimitationMutation) AddedCreatedAt() (r int32, exists bool) {
	v := m.addcreated_at
	if v == nil {
		return
	}
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *LimitationMutation) ResetCreatedAt() {
	m.created_at = nil
	m.addcreated_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *LimitationMutation) SetUpdatedAt(u uint32) {
	m.updated_at = &u
	m.addupdated_at = nil
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *LimitationMutation) UpdatedAt() (r uint32, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the Limitation entity.
// If the Limitation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LimitationMutation) OldUpdatedAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddUpdatedAt adds u to the "updated_at" field.
func (m *LimitationMutation) AddUpdatedAt(u int32) {
	if m.addupdated_at != nil {
		*m.addupdated_at += u
	} else {
		m.addupdated_at = &u
...
// AddedUpdatedAt returns the value that was added to the "updated_at" field in this mutation.
func (m *LimitationMutation) AddedUpdatedAt() (r int32, exists bool) {
	v := m.addupdated_at
	if v == nil {
		return
	}
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *LimitationMutation) ResetUpdatedAt() {
	m.updated_at = nil
	m.addupdated_at = nil
}

// SetDeletedAt sets the "deleted_at" field.
func (m *LimitationMutation) SetDeletedAt(u uint32) {
	m.deleted_at = &u
	m.adddeleted_at = nil
}

// DeletedAt returns the value of the "deleted_at" field in the mutation.
func (m *LimitationMutation) DeletedAt() (r uint32, exists bool) {
	v := m.deleted_at
	if v == nil {
		return
	}
...
// OldDeletedAt returns the old "deleted_at" field's value of the Limitation entity.
// If the Limitation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LimitationMutation) OldDeletedAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeletedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeletedAt adds u to the "deleted_at" field.
func (m *LimitationMutation) AddDeletedAt(u int32) {
	if m.adddeleted_at != nil {
		*m.adddeleted_at += u
	} else {
		m.adddeleted_at = &u
...
// AddedDeletedAt returns the value that was added to the "deleted_at" field in this mutation.
func (m *LimitationMutation) AddedDeletedAt() (r int32, exists bool) {
	v := m.adddeleted_at
	if v == nil {
		return
	}
...
// ResetDeletedAt resets all changes to the "deleted_at" field.
func (m *LimitationMutation) ResetDeletedAt() {
	m.deleted_at = nil
	m.adddeleted_at = nil
}

// SetCoinTypeID sets the "coin_type_id" field.
func (m *LimitationMutation) SetCoinTypeID(u uuid.UUID) {
	m.coin_type_id = &u
}

// CoinTypeID returns the value of the "coin_type_id" field in the mutation.
func (m *LimitationMutation) CoinTypeID() (r uuid.UUID, exists bool) {
	v := m.coin_type_id
	if v == nil {
		return
	}
...
// OldCoinTypeID returns the old "coin_type_id" field's value of the Limitation entity.
// If the Limitation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LimitationMutation) OldCoinTypeID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCoinTypeID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearCoinTypeID clears the value of the "coin_type_id" field.
func (m *LimitationMutation) ClearCoinTypeID() {
	m.coin_type_id = nil
	m.clearedFields[limitation.FieldCoinTypeID] = struct{}{}
}

// CoinTypeIDCleared returns if the "coin_type_id" field was cleared in this mutation.
func (m *LimitationMutation) CoinTypeIDCleared() bool {
	_, ok := m.clearedFields[limitation.FieldCoinTypeID]
	return ok
}

// ResetCoinTypeID resets all changes to the "coin_type_id" field.
func (m *LimitationMutation) ResetCoinTypeID() {
	m.coin_type_id = nil
	delete(m.clearedFields, limitation.FieldCoinTypeID)
}

// SetLimitation sets the "limitation" field.
func (m *LimitationMutation) SetLimitation(s string) {
	m.limitation = &s
}

// Limitation returns the value of the "limitation" field in the mutation.
func (m *LimitationMutation) Limitation() (r string, exists bool) {
	v := m.limitation
	if v == nil {
		return
	}
...
// OldLimitation returns the old "limitation" field's value of the Limitation entity.
// If the Limitation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LimitationMutation) OldLimitation(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLimitation is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldLimitation requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldLimitation: %w", err)
	}
	return oldValue.Limitation, nil
}

// ClearLimitation clears the value of the "limitation" field.
func (m *LimitationMutation) ClearLimitation() {
	m.limitation = nil
	m.clearedFields[limitation.FieldLimitation] = struct{}{}
}

// LimitationCleared returns if the "limitation" field was cleared in this mutation.
func (m *LimitationMutation) LimitationCleared() bool {
	_, ok := m.clearedFields[limitation.FieldLimitation]
	return ok
}

// ResetLimitation resets all changes to the "limitation" field.
func (m *LimitationMutation) ResetLimitation() {
	m.limitation = nil
	delete(m.clearedFields, limitation.FieldLimitation)
}

// SetAmount sets the "amount" field.
func (m *LimitationMutation) SetAmount(d decimal.Decimal) {
	m.amount = &d
}

// Amount returns the value of the "amount" field in the mutation.
func (m *LimitationMutation) Amount() (r decimal.Decimal, exists bool) {
	v := m.amount
	if v == nil {
		return
	}
...
// OldAmount returns the old "amount" field's value of the Limitation entity.
// If the Limitation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LimitationMutation) OldAmount(ctx context.Context) (v decimal.Decimal, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *LimitationMutation) ClearAmount() {
	m.amount = nil
	m.clearedFields[limitation.FieldAmount] = struct{}{}
}

// AmountCleared returns if the "amount" field was cleared in this mutation.
func (m *LimitationMutation) AmountCleared() bool {
	_, ok := m.clearedFields[limitation.FieldAmount]
	return ok
}

// ResetAmount resets all changes to the "amount" field.
func (m *LimitationMutation) ResetAmount() {
	m.amount = nil
	delete(m.clearedFields, limitation.FieldAmount)
}

// Where appends a list predicates to the LimitationMutation builder.
func (m *LimitationMutation) Where(ps ...predicate.Limitation) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *LimitationMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (Limitation).
func (m *LimitationMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *LimitationMutation) Fields() []string {
	fields := make([]string, 0, 6)
	if m.created_at != nil {
		fields = append(fields, limitation.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, limitation.FieldUpdatedAt)
	}
	if m.deleted_at != nil {
		fields = append(fields, limitation.FieldDeletedAt)
	}
	if m.coin_type_id != nil {
		fields = append(fields, limitation.FieldCoinTypeID)
	}
	if m.limitation != nil {
		fields = append(fields, limitation.FieldLimitation)
	}
	if m.amount != nil {
		fields = append(fields, limitation.FieldAmount)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *LimitationMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *LimitationMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case limitation.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case limitation.FieldUpdatedAt:
	...
	case limitation.FieldCoinTypeID:
		return m.OldCoinTypeID(ctx)
	case limitation.FieldLimitation:
		return m.OldLimitation(ctx)
	case limitation.FieldAmount:
		return m.OldAmount(ctx)
	}
	return nil, fmt.Errorf("unknown Limitation field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *LimitationMutation) SetField(name string, value ent.Value) error {
	switch name {
	case limitation.FieldCreatedAt:
		v, ok := value.(uint32)
		if !ok {
	...
	return fmt.Errorf("unknown Limitation field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *LimitationMutation) AddedFields() []string {
	var fields []string
	if m.addcreated_at != nil {
		fields = append(fields, limitation.FieldCreatedAt)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *LimitationMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case limitation.FieldCreatedAt:
		return m.AddedCreatedAt()
	case limitation.FieldUpdatedAt:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *LimitationMutation) AddField(name string, value ent.Value) error {
	switch name {
	case limitation.FieldCreatedAt:
		v, ok := value.(int32)
		if !ok {
	...
	return fmt.Errorf("unknown Limitation numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *LimitationMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(limitation.FieldCoinTypeID) {
		fields = append(fields, limitation.FieldCoinTypeID)
	}
	if m.FieldCleared(limitation.FieldLimitation) {
		fields = append(fields, limitation.FieldLimitation)
	}
	if m.FieldCleared(limitation.FieldAmount) {
		fields = append(fields, limitation.FieldAmount)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *LimitationMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *LimitationMutation) ClearField(name string) error {
	switch name {
	case limitation.FieldCoinTypeID:
		m.ClearCoinTypeID()
		return nil
	...
	return fmt.Errorf("unknown Limitation nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *LimitationMutation) ResetField(name string) error {
	switch name {
	case limitation.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *LimitationMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *LimitationMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *LimitationMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *LimitationMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *LimitationMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *LimitationMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *LimitationMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown Limitation unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *LimitationMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown Limitation edge %s", name)
}
