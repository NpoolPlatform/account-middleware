...
func (pq *PlatformQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (pq *PlatformQuery) FirstIDX(ctx context.Context) uint32 {
...
func (pq *PlatformQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (pq *PlatformQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (pq *PlatformQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (pq *PlatformQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PlatformQuery) prepareQuery(ctx context.Context) error {
	...
	if platform.Policy == nil {
		return errors.New("ent: uninitialized platform.Policy (forgotten import ent/runtime?)")
	}
	if err := platform.Policy.EvalQuery(ctx, pq); err != nil {
		return err
	}
	return nil
}
