...
func (gbc *GoodBenefitCreate) defaults() error {
	...
	if _, ok := gbc.mutation.AccountID(); !ok {
		if goodbenefit.DefaultAccountID == nil {
			return fmt.Errorf("ent: uninitialized goodbenefit.DefaultAccountID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := gbc.mutation.TransactionID(); !ok {
		if goodbenefit.DefaultTransactionID == nil {
			return fmt.Errorf("ent: uninitialized goodbenefit.DefaultTransactionID (forgotten import ent/runtime?)")
		}
